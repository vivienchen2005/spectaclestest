...
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),emissiveTextureLayout,l9_3);
vec4 l9_25=texture2D(emissiveTexture,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_emissiveTexture)
{
...
#endif
N3_Emissive=ssSRGB_to_Linear(l9_26.xyz)*ssSRGB_to_Linear(l9_0);
}
N3_Normal=normalize(tempGlobals.VertexNormal_WorldSpace);
if (N3_EnableNormalTexture)
{
vec3 l9_27=N3_Normal;
vec2 l9_28=N3_getUV(N3_NormalTextureCoord);
vec2 l9_29;
if (N3_EnableTextureTransform&&N3_NormalTextureTransform)
{
l9_29=N3_uvTransform(l9_28,N3_NormalTextureOffset,N3_NormalTextureScale,N3_NormalTextureRotation);
}
else
{
l9_29=l9_28;
...
#endif
float l9_31=l9_29.x;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x);
float l9_32=l9_31;
float l9_33=l9_29.y;
sc_SoftwareWrapEarly(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y);
float l9_34=l9_33;
vec2 l9_35;
float l9_36;
...
{
l9_37=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x==3;
}
#else
{
l9_37=(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0);
}
#endif
float l9_38=l9_32;
float l9_39=1.0;
sc_ClampUV(l9_38,normalTextureUvMinMax.x,normalTextureUvMinMax.z,l9_37,l9_39);
float l9_40=l9_38;
float l9_41=l9_39;
bool l9_42;
#if (SC_USE_CLAMP_TO_BORDER_normalTexture)
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0);
}
#endif
float l9_43=l9_34;
float l9_44=l9_41;
sc_ClampUV(l9_43,normalTextureUvMinMax.y,normalTextureUvMinMax.w,l9_42,l9_44);
l9_36=l9_44;
...
#endif
vec2 l9_45=sc_TransformUV(l9_35,(int(SC_USE_UV_TRANSFORM_normalTexture)!=0),normalTextureTransform);
float l9_46=l9_45.x;
float l9_47=l9_36;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).x,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTexture)!=0)),l9_47);
float l9_48=l9_45.y;
float l9_49=l9_47;
sc_SoftwareWrapLate(l9_48,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTexture,SC_SOFTWARE_WRAP_MODE_V_normalTexture).y,(int(SC_USE_CLAMP_TO_BORDER_normalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTexture)!=0)),l9_49);
float l9_50=l9_49;
vec3 l9_51=sc_SamplingCoordsViewToGlobal(vec2(l9_46,l9_48),normalTextureLayout,l9_30);
vec4 l9_52=texture2D(normalTexture,l9_51.xy,0.0);
vec4 l9_53;
#if (SC_USE_CLAMP_TO_BORDER_normalTexture)
{
l9_53=mix(normalTextureBorderColor,l9_52,vec4(l9_50));
}
#else
{
l9_53=l9_52;
...
#endif
N3_Normal=normalize(mat3(tempGlobals.VertexTangent_WorldSpace,tempGlobals.VertexBinormal_WorldSpace,l9_27)*mix(vec3(0.0,0.0,1.0),(l9_53.xyz*1.9921875)-vec3(1.0),vec3(N3_NormalScale)));
}
...
{
float l9_54=N3_Metallic;
float l9_55=N3_Roughness;
vec2 l9_56=N3_getUV(N3_MaterialParamsTextureCoord);
vec2 l9_57;
if (N3_EnableTextureTransform&&N3_MaterialParamsTextureTransform)
{
l9_57=N3_uvTransform(l9_56,N3_MaterialParamsTextureOffset,N3_MaterialParamsTextureScale,N3_MaterialParamsTextureRotation);
}
else
{
l9_57=l9_56;
...
#endif
float l9_59=l9_57.x;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x);
float l9_60=l9_59;
float l9_61=l9_57.y;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y);
float l9_62=l9_61;
vec2 l9_63;
float l9_64;
...
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0);
}
#endif
float l9_66=l9_60;
float l9_67=1.0;
sc_ClampUV(l9_66,metallicRoughnessTextureUvMinMax.x,metallicRoughnessTextureUvMinMax.z,l9_65,l9_67);
float l9_68=l9_66;
float l9_69=l9_67;
bool l9_70;
#if (SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y==3;
}
#else
{
...
float l9_71=l9_62;
float l9_72=l9_69;
sc_ClampUV(l9_71,metallicRoughnessTextureUvMinMax.y,metallicRoughnessTextureUvMinMax.w,l9_70,l9_72);
l9_64=l9_72;
...
#endif
vec2 l9_73=sc_TransformUV(l9_63,(int(SC_USE_UV_TRANSFORM_metallicRoughnessTexture)!=0),metallicRoughnessTextureTransform);
float l9_74=l9_73.x;
float l9_75=l9_64;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).x,(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture)!=0)),l9_75);
float l9_76=l9_73.y;
float l9_77=l9_75;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_metallicRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_metallicRoughnessTexture).y,(int(SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_metallicRoughnessTexture)!=0)),l9_77);
float l9_78=l9_77;
vec3 l9_79=sc_SamplingCoordsViewToGlobal(vec2(l9_74,l9_76),metallicRoughnessTextureLayout,l9_58);
vec4 l9_80=texture2D(metallicRoughnessTexture,l9_79.xy,0.0);
vec4 l9_81;
#if (SC_USE_CLAMP_TO_BORDER_metallicRoughnessTexture)
{
l9_81=mix(metallicRoughnessTextureBorderColor,l9_80,vec4(l9_78));
}
#else
{
l9_81=l9_80;
...
#endif
vec4 l9_82=vec4(0.0);
l9_82.w=N3_OcclusionStrength;
vec3 l9_83=vec3(1.0+(N3_OcclusionStrength*(l9_81.z-1.0)));
N3_Metallic=l9_54*l9_81.x;
N3_Roughness=l9_55*l9_81.y;
N3_Occlusion=vec4(l9_83.x,l9_83.y,l9_83.z,l9_82.w);
}
if (N3_TransmissionEnable)
{
vec3 l9_84=N3_BaseColor;
vec3 l9_85=N3_Emissive;
float l9_86=N3_Metallic;
vec2 l9_87=tempGlobals.gScreenCoord;
int l9_88;
...
float l9_108=l9_107;
vec3 l9_109=sc_SamplingCoordsViewToGlobal(vec2(l9_104,l9_106),screenTextureLayout,l9_88);
vec4 l9_110=texture2D(screenTexture,l9_109.xy,0.0);
vec4 l9_111;
#if (SC_USE_CLAMP_TO_BORDER_screenTexture)
{
...
#endif
N3_Background=ssSRGB_to_Linear(l9_111.xyz);
float l9_112;
if (N3_EnableTransmissionTexture)
{
vec2 l9_113=N3_getUV(N3_TransmissionTextureCoord);
vec2 l9_114;
if (N3_EnableTextureTransform&&N3_TransmissionTextureTransform)
{
l9_114=N3_uvTransform(l9_113,N3_TransmissionTextureOffset,N3_TransmissionTextureScale,N3_TransmissionTextureRotation);
}
else
{
l9_114=l9_113;
...
#endif
float l9_116=l9_114.x;
sc_SoftwareWrapEarly(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x);
float l9_117=l9_116;
float l9_118=l9_114.y;
sc_SoftwareWrapEarly(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y);
float l9_119=l9_118;
vec2 l9_120;
float l9_121;
...
{
l9_122=ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x==3;
}
#else
{
l9_122=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0);
}
#endif
float l9_123=l9_117;
float l9_124=1.0;
sc_ClampUV(l9_123,transmissionTextureUvMinMax.x,transmissionTextureUvMinMax.z,l9_122,l9_124);
float l9_125=l9_123;
float l9_126=l9_124;
bool l9_127;
#if (SC_USE_CLAMP_TO_BORDER_transmissionTexture)
{
l9_127=ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y==3;
}
#else
{
l9_127=(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0);
}
#endif
float l9_128=l9_119;
float l9_129=l9_126;
sc_ClampUV(l9_128,transmissionTextureUvMinMax.y,transmissionTextureUvMinMax.w,l9_127,l9_129);
l9_121=l9_129;
...
#endif
vec2 l9_130=sc_TransformUV(l9_120,(int(SC_USE_UV_TRANSFORM_transmissionTexture)!=0),transmissionTextureTransform);
float l9_131=l9_130.x;
float l9_132=l9_121;
sc_SoftwareWrapLate(l9_131,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).x,(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_transmissionTexture)!=0)),l9_132);
float l9_133=l9_130.y;
float l9_134=l9_132;
sc_SoftwareWrapLate(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_transmissionTexture,SC_SOFTWARE_WRAP_MODE_V_transmissionTexture).y,(int(SC_USE_CLAMP_TO_BORDER_transmissionTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_transmissionTexture)!=0)),l9_134);
float l9_135=l9_134;
vec3 l9_136=sc_SamplingCoordsViewToGlobal(vec2(l9_131,l9_133),transmissionTextureLayout,l9_115);
vec4 l9_137=texture2D(transmissionTexture,l9_136.xy,0.0);
vec4 l9_138;
#if (SC_USE_CLAMP_TO_BORDER_transmissionTexture)
{
l9_138=mix(transmissionTextureBorderColor,l9_137,vec4(l9_135));
}
#else
{
l9_138=l9_137;
...
vec3 l9_139=vec3(l9_112*N3_TransmissionFactor);
vec3 l9_140=vec3(l9_86);
N3_BaseColor=mix(mix(l9_84,vec3(0.0),l9_139),l9_84,l9_140);
N3_Emissive=mix(mix(vec3(0.0),l9_84,l9_139)*N3_Background,vec3(0.0),l9_140)+l9_85;
}
N3_BaseColor=ssLinear_to_SRGB(N3_BaseColor);
float l9_141=N3_Opacity;
float l9_142;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_142=pow(l9_141,0.45454544);
}
#else
{
l9_142=sqrt(l9_141);
...
if (N3_SheenEnable)
{
vec3 l9_143=N3_Normal;
vec4 l9_144=N3_Occlusion;
vec3 l9_145=N3_SheenColorFactor;
float l9_146=N3_SheenRoughnessFactor;
vec3 l9_147;
if (N3_EnableSheenTexture)
{
vec2 l9_148=N3_getUV(N3_SheenColorTextureCoord);
vec2 l9_149;
if (N3_EnableTextureTransform&&N3_SheenColorTextureTransform)
{
l9_149=N3_uvTransform(l9_148,N3_SheenColorTextureOffset,N3_SheenColorTextureScale,N3_SheenColorTextureRotation);
}
else
{
l9_149=l9_148;
...
#endif
float l9_151=l9_149.x;
sc_SoftwareWrapEarly(l9_151,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x);
float l9_152=l9_151;
float l9_153=l9_149.y;
sc_SoftwareWrapEarly(l9_153,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y);
float l9_154=l9_153;
vec2 l9_155;
float l9_156;
...
{
l9_157=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x==3;
}
#else
{
l9_157=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0);
}
#endif
float l9_158=l9_152;
float l9_159=1.0;
sc_ClampUV(l9_158,sheenColorTextureUvMinMax.x,sheenColorTextureUvMinMax.z,l9_157,l9_159);
float l9_160=l9_158;
float l9_161=l9_159;
bool l9_162;
#if (SC_USE_CLAMP_TO_BORDER_sheenColorTexture)
{
l9_162=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y==3;
}
#else
{
l9_162=(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0);
}
#endif
float l9_163=l9_154;
float l9_164=l9_161;
sc_ClampUV(l9_163,sheenColorTextureUvMinMax.y,sheenColorTextureUvMinMax.w,l9_162,l9_164);
l9_156=l9_164;
...
#endif
vec2 l9_165=sc_TransformUV(l9_155,(int(SC_USE_UV_TRANSFORM_sheenColorTexture)!=0),sheenColorTextureTransform);
float l9_166=l9_165.x;
float l9_167=l9_156;
sc_SoftwareWrapLate(l9_166,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).x,(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenColorTexture)!=0)),l9_167);
float l9_168=l9_165.y;
float l9_169=l9_167;
sc_SoftwareWrapLate(l9_168,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenColorTexture,SC_SOFTWARE_WRAP_MODE_V_sheenColorTexture).y,(int(SC_USE_CLAMP_TO_BORDER_sheenColorTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenColorTexture)!=0)),l9_169);
float l9_170=l9_169;
vec3 l9_171=sc_SamplingCoordsViewToGlobal(vec2(l9_166,l9_168),sheenColorTextureLayout,l9_150);
vec4 l9_172=texture2D(sheenColorTexture,l9_171.xy,0.0);
vec4 l9_173;
#if (SC_USE_CLAMP_TO_BORDER_sheenColorTexture)
{
l9_173=mix(sheenColorTextureBorderColor,l9_172,vec4(l9_170));
}
#else
{
l9_173=l9_172;
...
#endif
l9_147=l9_145*ssSRGB_to_Linear(l9_173.xyz);
}
else
{
l9_147=l9_145;
...
{
vec2 l9_175=N3_getUV(N3_SheenRoughnessTextureCoord);
vec2 l9_176;
if (N3_EnableTextureTransform&&N3_SheenRoughnessTextureTransform)
{
l9_176=N3_uvTransform(l9_175,N3_SheenRoughnessTextureOffset,N3_SheenRoughnessTextureScale,N3_SheenRoughnessTextureRotation);
}
else
{
l9_176=l9_175;
...
#endif
float l9_178=l9_176.x;
sc_SoftwareWrapEarly(l9_178,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x);
float l9_179=l9_178;
float l9_180=l9_176.y;
sc_SoftwareWrapEarly(l9_180,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y);
float l9_181=l9_180;
vec2 l9_182;
float l9_183;
...
{
l9_184=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x==3;
}
#else
{
l9_184=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0);
}
#endif
float l9_185=l9_179;
float l9_186=1.0;
sc_ClampUV(l9_185,sheenRoughnessTextureUvMinMax.x,sheenRoughnessTextureUvMinMax.z,l9_184,l9_186);
float l9_187=l9_185;
float l9_188=l9_186;
bool l9_189;
#if (SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)
{
l9_189=ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y==3;
}
#else
{
l9_189=(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0);
}
#endif
float l9_190=l9_181;
float l9_191=l9_188;
sc_ClampUV(l9_190,sheenRoughnessTextureUvMinMax.y,sheenRoughnessTextureUvMinMax.w,l9_189,l9_191);
l9_183=l9_191;
...
#endif
vec2 l9_192=sc_TransformUV(l9_182,(int(SC_USE_UV_TRANSFORM_sheenRoughnessTexture)!=0),sheenRoughnessTextureTransform);
float l9_193=l9_192.x;
float l9_194=l9_183;
sc_SoftwareWrapLate(l9_193,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).x,(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture)!=0)),l9_194);
float l9_195=l9_192.y;
float l9_196=l9_194;
sc_SoftwareWrapLate(l9_195,ivec2(SC_SOFTWARE_WRAP_MODE_U_sheenRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_sheenRoughnessTexture).y,(int(SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_sheenRoughnessTexture)!=0)),l9_196);
float l9_197=l9_196;
vec3 l9_198=sc_SamplingCoordsViewToGlobal(vec2(l9_193,l9_195),sheenRoughnessTextureLayout,l9_177);
vec4 l9_199=texture2D(sheenRoughnessTexture,l9_198.xy,0.0);
vec4 l9_200;
#if (SC_USE_CLAMP_TO_BORDER_sheenRoughnessTexture)
{
l9_200=mix(sheenRoughnessTextureBorderColor,l9_199,vec4(l9_197));
}
#else
{
l9_200=l9_199;
...
#endif
l9_174=l9_146*ssSRGB_to_Linear(l9_200.w);
}
else
{
l9_174=l9_146;
}
float l9_201=max(l9_174,9.9999997e-05);
N3_SheenOut=vec4(0.0);
vec3 l9_202=tempGlobals.ViewDirWS;
float l9_203=max(clamp(dot(l9_143,l9_202),0.0,1.0),9.9999997e-05);
float l9_204=l9_201*l9_201;
bool l9_205=l9_201<0.25;
float l9_206;
if (l9_205)
{
l9_206=(((-339.20001)*l9_204)+(161.39999*l9_201))-25.9;
}
else
{
l9_206=(((-8.4799995)*l9_204)+(14.3*l9_201))-9.9499998;
}
float l9_207;
if (l9_205)
{
l9_207=((44.0*l9_204)-(23.700001*l9_201))+3.26;
}
else
{
l9_207=((1.97*l9_204)-(3.27*l9_201))+0.72000003;
}
float l9_208=l9_206*l9_203;
float l9_209=l9_208+l9_207;
float l9_210;
if (l9_205)
{
l9_210=0.0;
...
{
l9_210=0.1*(l9_201-0.25);
}
vec3 l9_211=N3_SheenOut.xyz+((((sampleSpecularEnvTextureLod(normalize(reflect(-l9_202,l9_143)),3.0+((((l9_201*4.0)-0.0)*2.0)/5.0))*sc_EnvmapExposure)+vec3(1e-06))*l9_147)*clamp((exp(l9_209)+l9_210)*3.1415927,0.0,1.0));
N3_SheenOut=vec4(l9_211.x,l9_211.y,l9_211.z,N3_SheenOut.w);
vec3 l9_212=mix(N3_SheenOut.xyz,N3_SheenOut.xyz*l9_144.xyz,vec3(l9_144.w));
N3_SheenOut=vec4(l9_212.x,l9_212.y,l9_212.z,N3_SheenOut.w);
vec3 l9_213;
#if (sc_DirectionalLightsCount>0)
{
vec3 l9_214;
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_217=l9_216<sc_DirectionalLightsCount;
if (l9_217)
{
vec3 l9_218;
if (l9_217)
{
l9_218=sc_DirectionalLights[l9_216].color.xyz;
}
else
{
l9_218=vec3(0.0);
...
if (l9_217)
{
l9_219=sc_DirectionalLights[l9_216].color.w;
}
else
{
l9_219=0.0;
}
vec3 l9_220=l9_218*l9_219;
vec3 l9_221;
if (l9_217)
{
l9_221=-sc_DirectionalLights[l9_216].direction;
}
else
{
l9_221=vec3(0.0);
}
vec3 l9_222=normalize(-l9_221);
float l9_223=clamp(dot(l9_143,l9_222),0.0,1.0);
l9_215=l9_214+(((((l9_220*3.1415901)*l9_147)*N3_charlieD(l9_204,clamp(dot(l9_143,normalize(l9_222+l9_202)),0.0,1.0)))*(1.0/(4.0*((l9_223+l9_203)-(l9_223*l9_203)))))*l9_223);
l9_214=l9_215;
l9_216++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_228=l9_227<sc_PointLightsCount;
if (l9_228)
{
vec3 l9_229;
if (l9_228)
{
l9_229=sc_PointLights[l9_227].color.xyz;
}
else
{
l9_229=vec3(0.0);
...
if (l9_228)
{
l9_230=sc_PointLights[l9_227].color.w;
}
else
{
l9_230=0.0;
}
vec3 l9_231=l9_229*l9_230;
vec3 l9_232;
if (l9_228)
{
l9_232=sc_PointLights[l9_227].position;
}
else
{
l9_232=vec3(0.0);
}
vec3 l9_233=normalize(l9_232-tempGlobals.SurfacePosition_WorldSpace);
float l9_234=clamp(dot(l9_143,l9_233),0.0,1.0);
l9_226=l9_225+(((((l9_231*3.1415901)*l9_147)*N3_charlieD(l9_204,clamp(dot(l9_143,normalize(l9_233+l9_202)),0.0,1.0)))*(1.0/(4.0*((l9_234+l9_203)-(l9_234*l9_203)))))*l9_234);
l9_225=l9_226;
l9_227++;
continue;
}
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
l9_239=l9_238<sc_AmbientLightsCount;
if (l9_239)
{
vec3 l9_240;
if (l9_239)
{
l9_240=sc_AmbientLights[l9_238].color;
}
else
{
l9_240=vec3(0.0);
...
if (l9_239)
{
l9_241=sc_AmbientLights[l9_238].intensity;
}
else
{
l9_241=0.0;
}
l9_237=l9_236+(((l9_240*l9_241)/vec3(3.1415901))*l9_147);
l9_236=l9_237;
l9_238++;
continue;
}
...
#endif
vec3 l9_242=N3_SheenOut.xyz+l9_235;
N3_SheenOut=vec4(l9_242.x,l9_242.y,l9_242.z,N3_SheenOut.w);
N3_SheenOut.w=1.0-(max(max(l9_147.x,l9_147.y),l9_147.z)*0.15700001);
}
...
{
vec2 l9_243=N3_getUV(N3_ClearcoatTextureCoord);
vec2 l9_244;
if (N3_EnableTextureTransform&&N3_ClearcoatTextureTransform)
{
l9_244=N3_uvTransform(l9_243,N3_ClearcoatTextureOffset,N3_ClearcoatTextureScale,N3_ClearcoatTextureRotation);
}
else
{
l9_244=l9_243;
...
sc_SoftwareWrapEarly(l9_246,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x);
float l9_247=l9_246;
float l9_248=l9_244.y;
sc_SoftwareWrapEarly(l9_248,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y);
float l9_249=l9_248;
vec2 l9_250;
float l9_251;
...
{
l9_252=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x==3;
}
#else
{
l9_252=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0);
}
#endif
float l9_253=l9_247;
float l9_254=1.0;
sc_ClampUV(l9_253,clearcoatTextureUvMinMax.x,clearcoatTextureUvMinMax.z,l9_252,l9_254);
float l9_255=l9_253;
float l9_256=l9_254;
bool l9_257;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatTexture)
{
l9_257=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y==3;
}
#else
{
l9_257=(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0);
}
#endif
float l9_258=l9_249;
float l9_259=l9_256;
sc_ClampUV(l9_258,clearcoatTextureUvMinMax.y,clearcoatTextureUvMinMax.w,l9_257,l9_259);
l9_251=l9_259;
...
#endif
vec2 l9_260=sc_TransformUV(l9_250,(int(SC_USE_UV_TRANSFORM_clearcoatTexture)!=0),clearcoatTextureTransform);
float l9_261=l9_260.x;
float l9_262=l9_251;
sc_SoftwareWrapLate(l9_261,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).x,(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatTexture)!=0)),l9_262);
float l9_263=l9_260.y;
float l9_264=l9_262;
sc_SoftwareWrapLate(l9_263,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatTexture).y,(int(SC_USE_CLAMP_TO_BORDER_clearcoatTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatTexture)!=0)),l9_264);
float l9_265=l9_264;
vec3 l9_266=sc_SamplingCoordsViewToGlobal(vec2(l9_261,l9_263),clearcoatTextureLayout,l9_245);
vec4 l9_267=texture2D(clearcoatTexture,l9_266.xy,0.0);
vec4 l9_268;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatTexture)
{
l9_268=mix(clearcoatTextureBorderColor,l9_267,vec4(l9_265));
}
#else
{
l9_268=l9_267;
...
#endif
N3_ClearcoatBase=ssSRGB_to_Linear(l9_268.x);
}
N3_ClearcoatBase*=N3_ClearcoatFactor;
if (N3_EnableClearCoatRoughnessTexture)
{
vec2 l9_269=N3_getUV(N3_ClearcoatRoughnessTextureCoord);
vec2 l9_270;
if (N3_EnableTextureTransform&&N3_ClearcoatRoughnessTextureTransform)
{
l9_270=N3_uvTransform(l9_269,N3_ClearcoatRoughnessTextureOffset,N3_ClearcoatRoughnessTextureScale,N3_ClearcoatRoughnessTextureRotation);
}
else
{
l9_270=l9_269;
...
{
l9_271=1-sc_GetStereoViewIndex();
}
#else
{
l9_271=sc_GetStereoViewIndex();
}
#endif
float l9_272=l9_270.x;
sc_SoftwareWrapEarly(l9_272,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x);
float l9_273=l9_272;
float l9_274=l9_270.y;
sc_SoftwareWrapEarly(l9_274,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y);
float l9_275=l9_274;
vec2 l9_276;
float l9_277;
...
{
l9_278=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x==3;
}
#else
{
l9_278=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0);
}
#endif
float l9_279=l9_273;
float l9_280=1.0;
sc_ClampUV(l9_279,clearcoatRoughnessTextureUvMinMax.x,clearcoatRoughnessTextureUvMinMax.z,l9_278,l9_280);
float l9_281=l9_279;
float l9_282=l9_280;
bool l9_283;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)
{
l9_283=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y==3;
}
#else
{
l9_283=(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0);
}
#endif
float l9_284=l9_275;
float l9_285=l9_282;
sc_ClampUV(l9_284,clearcoatRoughnessTextureUvMinMax.y,clearcoatRoughnessTextureUvMinMax.w,l9_283,l9_285);
l9_277=l9_285;
...
#endif
vec2 l9_286=sc_TransformUV(l9_276,(int(SC_USE_UV_TRANSFORM_clearcoatRoughnessTexture)!=0),clearcoatRoughnessTextureTransform);
float l9_287=l9_286.x;
float l9_288=l9_277;
sc_SoftwareWrapLate(l9_287,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).x,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0)),l9_288);
float l9_289=l9_286.y;
float l9_290=l9_288;
sc_SoftwareWrapLate(l9_289,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatRoughnessTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatRoughnessTexture).y,(int(SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatRoughnessTexture)!=0)),l9_290);
float l9_291=l9_290;
vec3 l9_292=sc_SamplingCoordsViewToGlobal(vec2(l9_287,l9_289),clearcoatRoughnessTextureLayout,l9_271);
vec4 l9_293=texture2D(clearcoatRoughnessTexture,l9_292.xy,0.0);
vec4 l9_294;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatRoughnessTexture)
{
l9_294=mix(clearcoatRoughnessTextureBorderColor,l9_293,vec4(l9_291));
}
#else
{
l9_294=l9_293;
...
#endif
N3_ClearcoatRoughness=ssSRGB_to_Linear(l9_294.y);
}
N3_ClearcoatRoughness*=N3_ClearcoatRoughnessFactor;
if (N3_EnableClearCoatNormalTexture)
{
vec2 l9_295=N3_getUV(N3_ClearcoatNormalMapCoord);
vec2 l9_296;
if (N3_EnableTextureTransform&&N3_ClearcoatNormalTextureTransform)
{
l9_296=N3_uvTransform(l9_295,N3_ClearcoatNormalTextureOffset,N3_ClearcoatNormalTextureScale,N3_ClearcoatNormalTextureRotation);
}
else
{
l9_296=l9_295;
...
{
l9_297=1-sc_GetStereoViewIndex();
}
#else
{
l9_297=sc_GetStereoViewIndex();
}
#endif
float l9_298=l9_296.x;
sc_SoftwareWrapEarly(l9_298,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x);
float l9_299=l9_298;
float l9_300=l9_296.y;
sc_SoftwareWrapEarly(l9_300,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y);
float l9_301=l9_300;
vec2 l9_302;
float l9_303;
...
{
l9_304=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x==3;
}
#else
{
l9_304=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0);
}
#endif
float l9_305=l9_299;
float l9_306=1.0;
sc_ClampUV(l9_305,clearcoatNormalTextureUvMinMax.x,clearcoatNormalTextureUvMinMax.z,l9_304,l9_306);
float l9_307=l9_305;
float l9_308=l9_306;
bool l9_309;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)
{
l9_309=ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y==3;
}
#else
{
l9_309=(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0);
}
#endif
float l9_310=l9_301;
float l9_311=l9_308;
sc_ClampUV(l9_310,clearcoatNormalTextureUvMinMax.y,clearcoatNormalTextureUvMinMax.w,l9_309,l9_311);
l9_303=l9_311;
...
#endif
vec2 l9_312=sc_TransformUV(l9_302,(int(SC_USE_UV_TRANSFORM_clearcoatNormalTexture)!=0),clearcoatNormalTextureTransform);
float l9_313=l9_312.x;
float l9_314=l9_303;
sc_SoftwareWrapLate(l9_313,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).x,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0)),l9_314);
float l9_315=l9_312.y;
float l9_316=l9_314;
sc_SoftwareWrapLate(l9_315,ivec2(SC_SOFTWARE_WRAP_MODE_U_clearcoatNormalTexture,SC_SOFTWARE_WRAP_MODE_V_clearcoatNormalTexture).y,(int(SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_clearcoatNormalTexture)!=0)),l9_316);
float l9_317=l9_316;
vec3 l9_318=sc_SamplingCoordsViewToGlobal(vec2(l9_313,l9_315),clearcoatNormalTextureLayout,l9_297);
vec4 l9_319=texture2D(clearcoatNormalTexture,l9_318.xy,0.0);
vec4 l9_320;
#if (SC_USE_CLAMP_TO_BORDER_clearcoatNormalTexture)
{
l9_320=mix(clearcoatNormalTextureBorderColor,l9_319,vec4(l9_317));
}
#else
{
l9_320=l9_319;
...
#endif
N3_ClearcoatNormal=l9_320.xyz;
N3_ClearcoatNormal*=0.9921875;
}
}
vec3 l9_321=N3_BaseColor;
float l9_322=N3_Opacity;
vec3 l9_323=N3_Normal;
vec3 l9_324=N3_Emissive;
float l9_325=N3_Metallic;
float l9_326=N3_Roughness;
vec3 l9_327=N3_Background;
vec4 l9_328=N3_SheenOut;
float l9_329=N3_ClearcoatBase;
vec3 l9_330=N3_ClearcoatNormal;
float l9_331=N3_ClearcoatRoughness;
vec3 l9_332;
...
#else
{
l9_332=Globals.BumpedNormal;
}
#endif
float l9_333=clamp(l9_322,0.0,1.0);
ngsAlphaTest(l9_333);
vec3 l9_334=max(l9_321,vec3(0.0));
vec4 l9_335;
#if (sc_ProjectiveShadowsCaster)
{
l9_335=vec4(l9_334,l9_333);
}
#else
{
l9_335=ngsCalculateLighting(l9_334,l9_333,l9_332,Globals.PositionWS,Globals.ViewDirWS,max(l9_324,vec3(0.0)),clamp(l9_325,0.0,1.0),clamp(l9_326,0.0,1.0),clamp(N3_Occlusion.xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N036);
}
#endif
vec4 l9_336=max(l9_335,vec4(0.0));
vec3 l9_337;
#if (!sc_ProjectiveShadowsCaster)
{
l9_337=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_330;
}
#else
{
l9_337=Globals.BumpedNormal;
}
#endif
...
#if (sc_ProjectiveShadowsCaster)
{
l9_338=vec4(Port_Albedo_N405,Port_Opacity_N405);
}
#else
{
l9_338=ngsCalculateLighting(Port_Albedo_N405,Port_Opacity_N405,l9_337,Globals.PositionWS,Globals.ViewDirWS,Port_Emissive_N405,Port_Metallic_N405,clamp(l9_331,0.0,1.0),vec3(1.0),Port_SpecularAO_N405);
}
#endif
tempGlobals=Globals;
N31_PbrIn=l9_336;
...
N31_Opacity=l9_322;
N31_Background=l9_327;
N31_EnableSheen=(int(ENABLE_SHEEN)!=0);
N31_SheenColor=l9_328;
N31_EnableClearcoat=(int(ENABLE_CLEARCOAT)!=0);
N31_ClearcoatBase=l9_329;
N31_ClearcoatColor=max(l9_338,vec4(0.0));
...
if (N31_EnableSheen)
{
vec3 l9_339=(N31_Result.xyz*N31_SheenColor.w)+N31_SheenColor.xyz;
N31_Result=vec4(l9_339.x,l9_339.y,l9_339.z,N31_Result.w);
}
...
{
vec3 l9_340=N31_Result.xyz+(ssSRGB_to_Linear(N31_ClearcoatColor)*N31_ClearcoatBase).xyz;
N31_Result=vec4(l9_340.x,l9_340.y,l9_340.z,N31_Result.w);
}
